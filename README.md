...
School projects
1. Municipality themed mobile application with Java made on Android studio
2. C-programming project used to practice data structures and information handling with C-language
3. Municipality themed web application using JavaScript, HTML, CSS, Leafletjs, Frappe Charts, APIs
4. SQL database, two projects, one basic course and one advanced course.
5. Open source game addon testing project using Boost, programming language is C++ but I do not have much experience with this language.
6. 2D video game with Godot game engine. Programming language mainly GDScript.
